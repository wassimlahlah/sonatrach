      ...
      <div className="w-full max-w-5xl bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 p-5">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <button className="w-full mt-6 py-2 bg-gradient-to-br from-black to-orange-400 text-white cursor-pointer text-white rounded-lg hover:bg-gradient-to-br hover:from-black hover:to-orange-800 transition">
              Sign Up
            </button>
