    ...
    <div className="relative min-h-screen">
      ...
      <Routes>
        ...
        >
          ...
          />
          <Route path="/add-product-type" element={<SuperAdminRoute></SuperAdminRoute><AddProductType />} />
          <Route path="/edit-product-type/:id" element={<SuperAdminRoute></SuperAdminRoute><EditProductType />} />
