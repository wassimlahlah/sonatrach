...
function AddProduct() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-transpart border border-black/20 text-white">
      
      {/* CARD */}
      <div className="w-full max-w-lg bg-white text-black rounded-2xl shadow-lg p-6 border border-orange-500">
