...
function AddContract() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-transparent text-white">
      ...
      {/* CARD */}
      <div className="w-full max-w-lg bg-black/30 rounded-2xl shadow-lg p-6 border border-black/50">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <select
            ...
            className="w-full p-2 text-black rounded border border-black/70 focus:outline-none focus:ring-2 focus:ring-orange-500"
          >
