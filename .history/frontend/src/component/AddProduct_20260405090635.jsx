            ...
            <div className="w-full max-w-lg bg-black/30 text-black rounded-2xl shadow-lg p-6 border border-black/20">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex justify-center items-center gap-4">
                        ...
                        <NavLink to="/AddProduct" className="text-orange-400 px-4 py-2 text-xl hover:text-orange-600 transition">
                            <i className="fa-solid fa-plus"></i>
                        </NavLink>
                        <NavLink className="text-orange-400 px-4 py-2 text-xl hover:text-orange-600 transition">
