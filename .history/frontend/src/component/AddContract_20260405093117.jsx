      ...
      <div className="w-full max-w-lg bg-black/20 rounded-2xl shadow-lg p-6 border border-black/60">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input
            ...
            onChange={handleChange}
            className="w-full text-black p-2 border border-black rounded placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-orange-500"
          />
          ...
          <input
            ...
            value={form.endDate}
            onChange={handleChange}
            className="w-full p-2 text-black placeholder-gray-800 rounded border border-black focus:outline-none focus:ring-2 focus:ring-orange-500"
          />
