        ...
        <div className="min-h-screen flex items-center justify-center bg-transpart  text-white">
            ...
            <div className="w-full max-w-lg bg-black/30 text-black rounded-2xl shadow-lg p-6 border border-black/20">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <NavLink className="text-orange-400 px-4 py-2 hover:text-orange-400 hover:text-white transition">
                        <i className="fa-solid fa-plus"></i>
                    </NavLink>
                    <NavLink className="text-orange-400 px-4 py-2 hover:text-orange-500 hover:text-white transition">
