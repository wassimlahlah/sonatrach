      ...
      <div className="w-full max-w-lg bg-black/30 text-black rounded-2xl shadow-lg p-6 border border-black/20">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input
            ...
            className="w-full text-black p-2 border border-black-200 rounded focus:-none focus:ring-2 focus:ring-orange-500"
          />
          ...
          <input
            ...
            onChange={handleChange}
            className="w-full text-black p-2 border border-gray-300 rounded focus:-none focus:ring-2 focus:ring-orange-500"
          />
