    ...
    <div className="relative min-h-screen">
      ...
      <Routes>
        ...
        >
          ...
          />
          <Route path="/add-product-type" element={<SuperAdminRoute><AddProductType /></SuperAdminRoute>} />
          <Route path="/edit-product-type/:id" element={<SuperAdminRoute><EditProductType /></SuperAdminRoute>} />
